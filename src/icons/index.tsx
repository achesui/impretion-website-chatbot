...
export function XIcon({ size = 24, strokeWidth = 2, className = "" }) {
  return (
    <svg
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      className={`lucide lucide-x-icon lucide-x ${className}`.trim()}
    >
      <path d="M18 6 6 18" />
      <path d="m6 6 12 12" />
    </svg>
...
export function SendIcon({ size = 24, strokeWidth = 2, className = "" }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
export function AppointmentIcon({
  ...
  return (
    <svg
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      className={`lucide lucide-notebook-pen-icon lucide-notebook-pen ${className}`.trim()}
    >
...
export function OrderIcon({ size = 24, strokeWidth = 2, className = "" }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
      ...
      stroke-linecap="round"
      stroke-linejoin="round"
      className={`lucide lucide-package-open-icon lucide-package-open ${className}`.trim()}
    >
      <path d="M12 22v-9" />
...
export function ExternalLinkIcon({
  ...
  return (
    <svg
      ...
      stroke-linecap="round"
      stroke-linejoin="round"
      className={`lucide lucide-external-link-icon lucide-external-link ${className}`.trim()}
    >
      <path d="M15 3h6v6" />
      <path d="M10 14 21 3" />
...
export function PhoneIcon({
  ...
  return (
    <svg
      ...
      stroke-linecap="round"
      stroke-linejoin="round"
      className={`lucide lucide-phone-icon lucide-phone ${className}`.trim()}
    >
...
export function PhoneCancelIcon({ size = 24, strokeWidth = 2 }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
export function DotIcon({ size = 24, strokeWidth = 2 }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
export function PhoneCallIcon({ size = 24, strokeWidth = 2 }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
